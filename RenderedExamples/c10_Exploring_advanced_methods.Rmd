...
```{r 00401_example_10.1_of_section_10.1.1.R }
...
```{r 00402_informalexample_10.1_of_section_10.1.1.R }
...
```{r 00403_example_10.2_of_section_10.1.2.R }
...
```{r 00404_example_10.3_of_section_10.1.3.R }
...
```{r 00405_informalexample_10.2_of_section_10.1.3.R }
...
```{r 00406_informalexample_10.3_of_section_10.1.3.R }
...
```{r 00407_informalexample_10.4_of_section_10.1.3.R }
...
```{r 00408_example_10.4_of_section_10.1.3.R }
...
```{r 00409_example_10.5_of_section_10.1.3.R }
...
```{r 00410_example_10.6_of_section_10.1.4.R }
...
```{r 00411_example_10.7_of_section_10.1.4.R }
...
```{r 00412_example_10.8_of_section_10.1.4.R }
...
```{r 00413_informalexample_10.5_of_section_10.1.4.R }
...
```{r 00414_informalexample_10.6_of_section_10.1.4.R }
...
```{r 00415_informalexample_10.7_of_section_10.1.4.R }
...
```{r 00416_informalexample_10.8_of_section_10.1.4.R }
...
```{r 00417_example_10.9_of_section_10.1.4.R }
...
```{r 00418_example_10.10_of_section_10.1.4.R }
...
```{r 00419_example_10.11_of_section_10.1.4.R }
...
```{r 00422_example_10.12_of_section_10.2.2.R }
...
```{r 00423_example_10.13_of_section_10.2.2.R }
...
```{r 00424_example_10.14_of_section_10.2.2.R }
...
```{r 00425_example_10.15_of_section_10.2.2.R }
...
```{r 00426_example_10.16_of_section_10.2.3.R }
...
```{r 00427_example_10.17_of_section_10.2.4.R }
...
```{r 00428_example_10.18_of_section_10.2.4.R }
...
```{r 00429_example_10.19_of_section_10.2.4.R }
...
```{r 00430_example_10.20_of_section_10.2.5.R }
...
```{r 00431_example_10.21_of_section_10.2.5.R }
...
```{r 00432_example_10.22_of_section_10.3.1.R }
...
```{r 00433_example_10.23_of_section_10.3.1.R }
...
```{r 00434_example_10.24_of_section_10.3.1.R }
...
```{r 00438_example_10.25_of_section_10.3.3.R }
