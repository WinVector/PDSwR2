...
```{r 00477_example_B.1_of_section_B.1.1.R }
...
```{r 00478_example_B.2_of_section_B.1.1.R }
...
```{r 00479_example_B.3_of_section_B.1.1.R }
...
```{r 00480_example_B.4_of_section_B.1.1.R }
...
```{r 00481_example_B.5_of_section_B.1.3.R }
...
```{r 00482_example_B.6_of_section_B.1.3.R }
...
```{r 00483_example_B.7_of_section_B.1.4.R }
...
```{r 00484_example_B.8_of_section_B.1.4.R }
...
```{r 00485_example_B.9_of_section_B.1.4.R }
...
```{r 00486_example_B.10_of_section_B.1.4.R }
...
```{r 00487_example_B.11_of_section_B.1.4.R }
...
```{r 00489_example_B.12_of_section_B.2.2.R }
...
```{r 00490_example_B.13_of_section_B.2.2.R }
...
```{r 00491_example_B.14_of_section_B.2.2.R }
...
```{r 00492_example_B.15_of_section_B.2.2.R }
...
```{r 00493_example_B.16_of_section_B.2.2.R }
...
```{r 00494_example_B.17_of_section_B.2.2.R }
...
```{r 00495_example_B.18_of_section_B.2.2.R }
...
```{r 00496_example_B.19_of_section_B.2.3.R }
...
```{r 00497_example_B.20_of_section_B.2.3.R }
...
```{r 00498_example_B.21_of_section_B.2.4.R }
...
```{r 00499_example_B.22_of_section_B.2.4.R }
...
```{r 00500_example_B.23_of_section_B.3.1.R }
...
```{r 00501_example_B.24_of_section_B.3.1.R }
...
```{r 00502_example_B.25_of_section_B.3.2.R }
...
```{r 00503_example_B.26_of_section_B.3.2.R }
...
```{r 00504_example_B.27_of_section_B.3.2.R }
...
```{r 00505_example_B.28_of_section_B.3.2.R }
