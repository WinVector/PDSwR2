...
```{r 00397_example_B.1_of_section_B.1.1.R }
...
```{r 00398_example_B.2_of_section_B.1.1.R }
...
```{r 00399_example_B.3_of_section_B.1.1.R }
...
```{r 00400_example_B.4_of_section_B.1.1.R }
...
```{r 00401_example_B.5_of_section_B.1.3.R }
...
```{r 00402_example_B.6_of_section_B.1.3.R }
...
```{r 00403_example_B.7_of_section_B.1.4.R }
...
```{r 00404_example_B.8_of_section_B.1.4.R }
...
```{r 00405_example_B.9_of_section_B.1.4.R }
...
```{r 00406_example_B.10_of_section_B.1.4.R }
...
```{r 00407_example_B.11_of_section_B.1.4.R }
...
```{r 00409_example_B.12_of_section_B.2.2.R }
...
```{r 00410_example_B.13_of_section_B.2.2.R }
...
```{r 00411_example_B.14_of_section_B.2.2.R }
...
```{r 00412_example_B.15_of_section_B.2.2.R }
...
```{r 00413_example_B.16_of_section_B.2.2.R }
...
```{r 00414_informalexample_B.2_of_section_B.2.3.R }
...
```{r 00415_example_B.17_of_section_B.2.4.R }
...
```{r 00416_example_B.18_of_section_B.2.4.R }
...
```{r 00417_informalexample_B.3_of_section_B.2.4.R }
...
```{r 00418_example_B.19_of_section_B.3.1.R }
...
```{r 00419_example_B.20_of_section_B.3.1.R }
...
```{r 00420_example_B.21_of_section_B.3.2.R }
...
```{r 00421_example_B.22_of_section_B.3.2.R }
...
```{r 00422_example_B.23_of_section_B.3.2.R }
...
```{r 00423_example_B.24_of_section_B.3.2.R }
