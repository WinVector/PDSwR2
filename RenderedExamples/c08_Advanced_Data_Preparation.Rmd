...
```{r 00327_example_8.1_of_section_8.2.1.R }
...
```{r 00328_informalexample_8.1_of_section_8.2.1.R }
...
```{r 00329_informalexample_8.2_of_section_8.2.1.R }
...
```{r 00330_example_8.2_of_section_8.2.2.R , error = TRUE }
...
```{r 00331_example_8.3_of_section_8.2.2.R }
...
```{r 00332_informalexample_8.3_of_section_8.2.2.R }
...
```{r 00333_example_8.4_of_section_8.3.R }
...
```{r 00334_example_8.5_of_section_8.3.R }
...
```{r 00335_informalexample_8.4_of_section_8.3.1.R }
...
```{r 00336_informalexample_8.5_of_section_8.3.1.R }
...
```{r 00337_informalexample_8.6_of_section_8.3.1.R }
...
```{r 00338_informalexample_8.7_of_section_8.3.1.R }
...
```{r 00339_informalexample_8.8_of_section_8.3.1.R }
...
```{r 00340_informalexample_8.9_of_section_8.3.2.R }
...
```{r 00341_informalexample_8.10_of_section_8.3.2.R }
...
```{r 00342_example_8.6_of_section_8.4.1.R }
...
```{r 00343_informalexample_8.11_of_section_8.4.1.R }
...
```{r 00344_informalexample_8.12_of_section_8.4.2.R }
...
```{r 00345_example_8.7_of_section_8.4.2.R }
...
```{r 00346_informalexample_8.13_of_section_8.4.2.R }
...
```{r 00347_informalexample_8.14_of_section_8.4.2.R }
...
```{r 00348_informalexample_8.15_of_section_8.4.2.R }
...
```{r 00349_informalexample_8.16_of_section_8.4.2.R }
...
```{r 00350_informalexample_8.17_of_section_8.5.R }
...
```{r 00351_informalexample_8.18_of_section_8.5.R }
...
```{r 00352_informalexample_8.19_of_section_8.5.R }
...
```{r 00353_informalexample_8.20_of_section_8.6.2.R }
...
```{r 00354_informalexample_8.21_of_section_8.6.2.R }
...
```{r 00355_informalexample_8.22_of_section_8.6.3.R }
...
```{r 00356_informalexample_8.23_of_section_8.6.4.R }
...
```{r 00357_informalexample_8.24_of_section_8.6.4.R }
...
```{r 00358_informalexample_8.25_of_section_8.6.5.R }
...
```{r 00359_informalexample_8.26_of_section_8.6.5.R }
...
```{r 00360_example_8.8_of_section_8.6.6.R }
...
```{r 00361_example_8.9_of_section_8.6.6.R }
...
```{r 00362_example_8.10_of_section_8.6.6.R }
