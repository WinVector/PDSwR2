# example A.12 of section A.3.1 
# (example A.12 of section A.3.1)  : Working with R and other tools : Using databases with R : An example SQL data transformation task 
