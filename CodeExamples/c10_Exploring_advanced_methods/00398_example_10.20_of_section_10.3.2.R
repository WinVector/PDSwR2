# example 10.20 of section 10.3.2 
# (example 10.20 of section 10.3.2)  : Exploring advanced methods : Using kernel methods to increase data separation : Using an explicit kernel on a problem 
