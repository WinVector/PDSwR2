# example 10.27 of section 10.4.3 
# (example 10.27 of section 10.4.3)  : Exploring advanced methods : Using SVMs to model complicated decision boundaries : Using SVMs on real data 
