# example 10.16 of section 10.3.1 
# (example 10.16 of section 10.3.1)  : Exploring advanced methods : Using kernel methods to increase data separation : Understanding kernel functions 
