# example 10.23 of section 10.4.2 
# (example 10.23 of section 10.4.2)  : Exploring advanced methods : Using SVMs to model complicated decision boundaries : Trying an SVM on artificial example data 
