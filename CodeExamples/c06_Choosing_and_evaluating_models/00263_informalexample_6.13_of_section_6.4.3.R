# informalexample 6.13 of section 6.4.3 
# (informalexample 6.13 of section 6.4.3)  : Choosing and evaluating models : Local Interpretable Model-Agnostic Explanations (LIME) for explaining model predictions : LIME for Text Classification 
