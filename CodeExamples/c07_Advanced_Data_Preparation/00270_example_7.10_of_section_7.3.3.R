# example 7.10 of section 7.3.3 
# (example 7.10 of section 7.3.3)  : Advanced Data Preparation : Building single-variable models : Building single variable models from numeric features 
