# example 7.12 of section 7.2.4 
# (example 7.12 of section 7.2.4)  : Advanced Data Preparation : Building single-variable models : Using cross-validation to estimate effects of overfitting 
