# example 11.6 of section 11.2.3 
# (example 11.6 of section 11.2.3)  : Documentation and deployment : Using knitr to produce milestone documentation : Using knitr to document the buzz data 
