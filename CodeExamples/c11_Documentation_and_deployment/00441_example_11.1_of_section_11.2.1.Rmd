...
# Note 2: 
#   An R markdown "start code chunk" annotation. The "include = FALSE" directive says the block is not shown in the rendering. 
...
# Note 5: 
#   Another R code block. In this case we are loading an already produced randomForest model and test data. 
