# example 8.17 of section 8.2.5 
# (example 8.17 of section 8.2.5)  : Linear and logistic regression : Using logistic regression : Reading the model summary and characterizing coefficients 
