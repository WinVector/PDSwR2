# example 8.32 of section 8.3.5 
# (example 8.32 of section 8.3.5)  : Linear and logistic regression : Regularization : Regularized regression with glmnet 
...
# Note 1: 
#   A function to get the mean cross-validation error of a cv.glmnet model. 
