# example 8.7 of section 8.1.5 
# (example 8.7 of section 8.1.5)  : Linear and logistic regression : Using linear regression : Reading the model summary and characterizing coefficient quality 
