# example 8.17 of section 8.2.4 
# (example 8.17 of section 8.2.4)  : Linear and logistic regression : Using logistic regression : Finding relations and extracting advice from logistic models 
