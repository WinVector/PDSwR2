# example 8.16 of section 8.4.2 
# (example 8.16 of section 8.4.2)  : Advanced Data Preparation : Building models using many variables : Building a multi variable model 
