# example 8.8 of section 8.3.1 
# (example 8.8 of section 8.3.1)  : Advanced Data Preparation : Building single-variable models : Building single variable models from categorical features 
...
#   only want a model of type "catB" (we will explain this later), and verbose=FALSE is merely turning off some messages. 
