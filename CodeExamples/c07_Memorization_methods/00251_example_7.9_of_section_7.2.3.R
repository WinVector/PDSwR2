# example 7.9 of section 7.2.3 
# (example 7.9 of section 7.2.3)  : Memorization methods : Building single-variable models : Using cross-validation to estimate effects of overfitting 
